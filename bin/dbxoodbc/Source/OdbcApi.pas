...
function LoadOdbcDriverManager(LibraryName: PChar; UnicodePriority: Boolean = False): TOdbcApiProxy;
...
function LoadOdbcDriverManager(LibraryName: PChar; UnicodePriority: Boolean): TOdbcApiProxy;
begin
  Result := fOdbcApi;
...
begin
  ...
  try
    ...
    repeat
      ...
      sLibKey := IntToStr(Integer(UnicodePriority)) + ',' + IntToStr(vOdbcDriverLevel) + ':' + sLib;
