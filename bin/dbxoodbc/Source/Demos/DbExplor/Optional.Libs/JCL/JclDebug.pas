...
{+}
procedure JclRemoveLastExceptStackList();
{+.}
...
type
  ...
  private
    ...
    {+}
    procedure RemoveExceptStackInfo();
    {+.}
  public
    destructor Destroy; override;
...
{+}
procedure TJclGlobalStackList.RemoveExceptStackInfo();
var
  ReplacedObj: TObject;
begin
  with LockList do
  try
    ReplacedObj := FindObject(GetCurrentThreadId, TJclStackInfoList);
...
procedure JclRemoveLastExceptStackList();
begin
  GlobalStackList.RemoveExceptStackInfo();
end;
{+.}
