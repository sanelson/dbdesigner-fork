...
begin
  ...
  begin
    ...
    begin
      ...
      // replace current driver for static linking DbxOpenOdbc.pas, DbxOpenOdbc3.pas
      DbxOpenOdbcInterface.RegisterDbXpressLibW();
    end
    else
    begin
      SQLConnection.GetDriverFunc := 'getSQLDriverODBCWA';
      // replace current driver for static linking DbxOpenOdbc.pas, DbxOpenOdbc3.pas
      DbxOpenOdbcInterface.RegisterDbXpressLibWA();
    end;
  end
  else
  begin
    ...
    begin
      ...
      // replace current driver for static linking DbxOpenOdbc.pas, DbxOpenOdbc3.pas
      DbxOpenOdbcInterface.RegisterDbXpressLibA();
    end
    else
    begin
      SQLConnection.GetDriverFunc := 'getSQLDriverODBCAW';
      // replace current driver for static linking DbxOpenOdbc.pas, DbxOpenOdbc3.pas
      DbxOpenOdbcInterface.RegisterDbXpressLibAW();
    end;
  end;
